...
if __name__ == "__main__":
    ...
    chig = md.load(r"C:\Users\Administrator\Documents\WeChat Files\wxid_iagpqtxayzg922\FileStorage\File\2025-04\test.pdb")
    topology = chig.topology
    cart_ind = [1, 2, 3, 4, 5, 8, 22, 24, 25, 26, 29, 43, 45, 46, 47, 50, 55, 57, 59, 61, 64, 67, 69, 71, 72, 73,
                76, 79, 84, 86, 87, 88, 98, 100, 101, 102, 103, 105, 107, 108, 109, 119, 121, 122, 123, 126, 143,
                145, 146, 147, 148, 149, 150, 153]


    #[1,2,3,13,14,15,17,24,25,26,36,38,45,46,47,53,55,57,58,59,64,67,69,71,72,73,80,82,84,86,87,
    #            88,93,100,101,102,104,105,107,108,109,114,121,122,123,135,137,145,146,147,148,149,158,160]
    cart_ind_minus_one = [x - 1 for x in cart_ind]
    molecules = [MoleculeExtent(0, topology.n_residues, True)]
    Z_matrix = mdtraj_to_z(topology, cart_ind_minus_one, molecules)
    print(Z_matrix)

    """
    chig = md.load(r"C:/Users\Administrator\Desktop\GFM\pdb_data\AD_A.pdb")
    topology = chig.topology
    cart_ind = [6, 8, 14]
    molecules = [MoleculeExtent(0, topology.n_residues, True)]
    # molecules = []
    Z_matrix = mdtraj_to_z(topology, cart_ind, molecules)
    print(Z_matrix)
    """