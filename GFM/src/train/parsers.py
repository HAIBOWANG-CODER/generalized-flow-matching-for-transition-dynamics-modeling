...
def image_datasets_parser(parser):
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Preprocess to get latent space, otherwise files provided",
    )
    parser.add_argument(
        "--x0_label",
        type=str,
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=str,
        default=["dog", "cat", "wild"],
    )
    parser.add_argument(
        "--manifold_labels_weights",
        nargs="+",
        type=float,
        default=[1, 1, 1],
    )
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Use ambient space for training",
    )
    parser.add_argument(
        "--plot_interval",
        type=int,
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Flatten image for training",
    )
    parser.add_argument(
        "--flatten_image",
        action=argparse.BooleanOptionalAction,
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Preprocess for GSBM",
    )
    parser.add_argument(
        "--cluster_ambient",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Cluster in ambient space",
    )
    return parser
...
def metric_parser(parser):
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Alpha parameter for Bending strength, should be either 1 or 0",
    )
    parser.add_argument(
        "--n_centers",
        type=int,
...
def spline_network_parser(parser):
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Use deepset for Bend training",
    )
    parser.add_argument(
        "--hidden_dim_deepset",
        nargs="+",
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Use time in Bend model",
    )
    parser.add_argument(
        "--time_embedding_type",
        type=str,
        default="cat",
        help="Time embedding type for Bend model: cat, mlp, sin",
    )
    parser.add_argument(
        "--activation_bend",
        type=str,
        default="selu",
        help="Activation function for Bend",
    )
    parser.add_argument(
        "--bend_optimizer",
        type=str,
        default="adam",
        help="Optimizer for Bend training",
    )
    parser.add_argument(
        "--spline_lr",
        type=float,
        default=1e-4,
        help="Learning rate for Bend training",
    )
    parser.add_argument(
        "--spline_lr_re",
        type=float,
        default=1e-4,
        help="Learning rate for Bend retraining",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1e-5,
        help="Weight decay for Bend training",
    )
    parser.add_argument(
        "--unet_num_channels_bend",
        type=int,
        default=64,
        help="Number of channels for UNet",
    )
    parser.add_argument(
        "--unet_num_res_blocks_bend",
        type=int,
        default=2,
        help="Number of res blocks for UNet",
    )
    parser.add_argument(
        "--unet_channel_mult_bend",
        nargs="+",
        type=int,
        default=[1, 2, 2],
