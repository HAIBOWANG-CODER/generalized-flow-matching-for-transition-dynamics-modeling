...
class SampleDataset(Dataset):
    """
        A PyTorch Dataset class for loading and managing molecular coordinate data.
    """
...
class spline(nn.Module):
    """
     A neural network module that performs interpolation between two input points using a model and a forward network.
    """
