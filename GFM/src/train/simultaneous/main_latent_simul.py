...
def train_gfm(spline, flow_net, x0_loader, x1_loader, optimizer, num_epochs):
    spline.train()
...
train_gfm(spline, flow_net, x0_loader, x1_loader, optimizer, num_epochs=epochs)
