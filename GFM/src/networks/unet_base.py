...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        num_classes=None,
        use_checkpoint=False,
        use_checkpoint_attention=False,
        use_fp16=False,
        num_heads=1,
        num_head_channels=-1,
            ...
            for _ in range(num_res_blocks):
                ...
                if ds in attention_resolutions:
                    layers.append(
                        AttentionBlock(
                            ch,
                            use_checkpoint=use_checkpoint_attention,
                            num_heads=num_heads,
...
class UNetModelWrapper(UNetModel):
    def __init__(
        ...
        return super().__init__(
            ...
            in_channels=dim[0] * (2 if bend_model else 1),
            ...
            use_checkpoint=use_checkpoint,
            use_checkpoint_attention=(True if not bend_model else False),
            use_fp16=use_fp16,
            num_heads=num_heads,
            num_head_channels=num_head_channels,
